<?php
	...
	*/
	...
	function AptPdoUpdateWithAes($Data=array()){
		...
		if($Update == '' || $DbCon == '' || $TbName == '' || $EPass == '' || $DefaultCheckFor == '' || $DefaultCheckType == '' || ($AcceptNullCondtion != False && $AcceptNullCondtion != true) || ($AcceptNullUpdate != False && $AcceptNullUpdate != true)){
