<?php
	...
	define("PageTitle", "Manage Request");
	define("CssFile", "PerrmissionGiver");
	require_once RootPath."Site_Header/index.php";
?>
<body class="No_Select_Strat">
	<H1 class='PageTitle'>MANAGE REQUEST</H1>
	<div class='Container'>
		<?php
			if($ResponseCheckServiceBuyStatus['msg']['ServiceBuy'] != True){ 
				FullPageErrorMessageDisplay('This service is not buyed buy this organization',true,['MSGpadding'=>'40vh 10px']); exit();
			}
		?>
		<div class='button NewRequest'>
			<p>New Request</p>
		</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		$('.NewRequest').click(function(){
			window.location.href = 'NewRequest/index.php';
		});
	});
</script>
