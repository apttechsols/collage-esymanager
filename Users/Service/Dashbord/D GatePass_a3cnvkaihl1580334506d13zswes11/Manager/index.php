<?php
	...
	define("PageTitle", "D GatePass : Manager");
	define("CssFile", "Manager");
	require_once RootPath."Site_Header/index.php";

?>
<body class="No_Select_Strat">
	<H1 class='PageTitle'>MANAGER</H1>
	<div class='Container'>
		<?php
...
<script type="text/javascript">
	$(document).ready(function(){
		$('.AddMember').click(function(){
			window.location.href = 'AddMember/index.php';
		});

		$('.SearchMember').click(function(){
			window.location.href = 'SearchMember/index.php';
		});

		$('.Inbox').click(function(){
			window.location.href = 'Inbox/index.php';
		});
		
		$('.Setting').click(function(){
			window.location.href = 'Setting/index.php';
		});
