<?php
	...
	define("PageTitle", "Check Permission");
	define("CssFile", "PerrmissionChecker");
	require_once RootPath."Site_Header/index.php";
?>
<body class="No_Select_Strat">
	<H1 class='PageTitle'>CHECK PERMISSION</H1>
	<div class='Container'>
		<?php
			if($ResponseCheckServiceBuyStatus['msg']['ServiceBuy'] != True){ ?>
				<p>This service is not buyed buy <?php echo $ResponseLogin['LFR']; ?></p>
		<?php exit(); } ?>
		<div class='button OutGoingByQrCode'>
			<p>OutGoing By QR</p>
		</div>
		<div class='button InComingByQrCode'>
			<p>InComing By QR</p>
		</div>
		<div class='button Inbox'>
			<p>Inbox</p>
		</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		$('.CheckForUser').click(function(){
			window.location.href = 'CheckForUser/index.php';
		});

		$('.OutGoingByQrCode').click(function(){
			window.location.href = 'OutGoingByQrCode/index.php';
		});

		$('.InComingByQrCode').click(function(){
			window.location.href = 'InComingByQrCode/index.php';
		});
	});
</script>>
