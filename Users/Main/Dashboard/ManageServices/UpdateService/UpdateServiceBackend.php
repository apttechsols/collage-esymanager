<?php
	/*
	@FileName UpdateServiceBackend.php
...
if(isset($_POST['ServiceCode']) && isset($_POST['ServiceStatus']) && isset($_POST['ServiceName']) && isset($_POST['ServiceStartTime']) && isset($_POST['ServiceExpTime']) && isset($_POST['ServiceMember']) && isset($_POST['ServiceFor']) && isset($_POST['MaxSellLimit']) && isset($_POST['AllOffersPermission']) && isset($_POST['SpecialOffersPermission']) && isset($_POST['PrivateOffersPermission']) && isset($_POST['AllMaxDiscountAmount']) && isset($_POST['SpecialOffersMaxDiscountAmount']) && isset($_POST['PrivateOffersMaxDiscountAmount']) && isset($_POST['AllMaxDiscountPercentage']) && isset($_POST['SpecialOffersMaxDiscountPercentage']) && isset($_POST['PrivateOffersMaxDiscountPercentage']) && isset($_POST['ServicePackWork']) && isset($_POST['ServiceDescription']) && isset($_POST['ServiceTablesAndColumns']) && isset($_POST['TablesDefaultValues']) && isset($_POST['Version']) && isset($_POST['SecurityCode']) && isset($_POST['Token_CSRF']) && isset($_POST['BrowserClientId1']) && isset($_POST['BrowserClientId2'])){

	require_once (RootPath."JsonShowError/index.php");

	// Verify data send from same page or not
	if($_SERVER['HTTP_REFERER'] === DomainName."/Users/Main/Dashboard/ManageServices/UpdateService/index.php?target=".$_POST['ServiceCode'] || $_SERVER['HTTP_REFERER'] === DomainName."/Users/Main/Dashboard/ManageServices/UpdateService/?target=".$_POST['ServiceCode'] ){
		session_start();
		if($_POST['Token_CSRF'] === $_SESSION['Token_CSRF']){

			// Create variable from get data by request (example Post and Get methos)

			$ServiceCode = preg_replace('!\s+!', ' ',strip_tags($_POST['ServiceCode']));
			...
			$Version = preg_replace('/[.]+/', '.', preg_replace('!\s+!', ' ',strip_tags($_POST['Version'])));
			...
			class UpdateService{
				public static function ValidedData($ServiceCode,$ServiceStatus,$ServiceName,$ServiceStartTime,$ServiceExpTime,$ServiceFor,$ServiceMember,$MaxSellLimit,$AllOffersPermission,$SpecialOffersPermission,$PrivateOffersPermission,$AllMaxDiscountAmount,$SpecialOffersMaxDiscountAmount,$PrivateOffersMaxDiscountAmount,$AllMaxDiscountPercentage,$SpecialOffersMaxDiscountPercentage,$PrivateOffersMaxDiscountPercentage,$ServicePackWork,$ServiceDescription,$ServiceTablesAndColumns,$TablesDefaultValues,$Version,$SecurityCode,$BrowserClientId1,$BrowserClientId2){
					...
					if($ServiceCode != preg_replace("/[^A-Za-z0-9]/","",$ServiceCode)){
						return_response("Invalid target detect 1.0"); exit();

					}else if(strlen($ServiceCode) != 30){
						return_response("Invalid target detect 1.1"); exit();
					}
					...
					if($ServiceName != preg_replace("/[^A-Za-z0-9_ -]/","",$ServiceName)){
						...
						return_response("Service Name name must be between 3 and 50 characters long");
					}

					// ServiceStartTime validation
					if($ServiceStartTime != -1){
						if($ServiceStartTime != preg_replace("/[^0-9]/","",$ServiceStartTime)){
							return_response("Service Start Time contains invalid characters");  exit();
						}else if(strlen($ServiceStartTime) == 0){
							return_response("Invalid Service Start Time detect");  exit();
						}else if($ServiceStartTime > $CurrentTime+31104000){
					...
					if($ServiceExpTime != -1){
						if($ServiceExpTime != preg_replace("/[^0-9]/","",$ServiceExpTime)){
							return_response("Service Exp Time contains invalid characters");  exit();
						}else if(strlen($ServiceExpTime) == 0){
							return_response("Invalid Service Exp Time detect");  exit();
						}else if($ServiceExpTime > $CurrentTime+31104000){
					...
					if($Version != preg_replace("/[^0-9.]/","",$Version)){
						return_response('Service version contains invalid characters');
					}else if(strlen($Version) > 10 || strlen($Version) < 5){
						return_response('Service version cross maximum(10) or minimum(5) character limit');
					}
					...
					UpdateService::EncryptData($ServiceCode,$ServiceStatus,$ServiceName,$ServiceStartTime,$ServiceExpTime,$ServiceFor,$ServiceMember,$MaxSellLimit,$AllOffersPermission,$SpecialOffersPermission,$PrivateOffersPermission,$AllMaxDiscountAmount,$SpecialOffersMaxDiscountAmount,$PrivateOffersMaxDiscountAmount,$AllMaxDiscountPercentage,$SpecialOffersMaxDiscountPercentage,$PrivateOffersMaxDiscountPercentage,$ServicePackWork,$ServiceDescription,$ServiceTablesAndColumns,$TablesDefaultValues,$Version,$SecurityCode,$BrowserClientId1,$BrowserClientId2);
				}

				private static function EncryptData($ServiceCode,$ServiceStatus,$ServiceName,$ServiceStartTime,$ServiceExpTime,$ServiceFor,$ServiceMember,$MaxSellLimit,$AllOffersPermission,$SpecialOffersPermission,$PrivateOffersPermission,$AllMaxDiscountAmount,$SpecialOffersMaxDiscountAmount,$PrivateOffersMaxDiscountAmount,$AllMaxDiscountPercentage,$SpecialOffersMaxDiscountPercentage,$PrivateOffersMaxDiscountPercentage,$ServicePackWork,$ServiceDescription,$ServiceTablesAndColumns,$TablesDefaultValues,$Version,$SecurityCode,$BrowserClientId1,$BrowserClientId2){
					...
					UpdateService::CkeckLoginAndAuthenticate($ServiceCode,$ServiceStatus,$ServiceName,$ServiceStartTime,$ServiceExpTime,$ServiceFor,$ServiceMember,$MaxSellLimit,$AllOffersPermission,$SpecialOffersPermission,$PrivateOffersPermission,$AllMaxDiscountAmount,$SpecialOffersMaxDiscountAmount,$PrivateOffersMaxDiscountAmount,$AllMaxDiscountPercentage,$SpecialOffersMaxDiscountPercentage,$PrivateOffersMaxDiscountPercentage,$ServicePackWork,$ServiceDescription,$ServiceTablesAndColumns,$TablesDefaultValues,$Version,$SecurityCode,$BrowserClientId1,$BrowserClientId2,$EncodeAndEncryptPass);
				}

				private static function CkeckLoginAndAuthenticate($ServiceCode,$ServiceStatus,$ServiceName,$ServiceStartTime,$ServiceExpTime,$ServiceFor,$ServiceMember,$MaxSellLimit,$AllOffersPermission,$SpecialOffersPermission,$PrivateOffersPermission,$AllMaxDiscountAmount,$SpecialOffersMaxDiscountAmount,$PrivateOffersMaxDiscountAmount,$AllMaxDiscountPercentage,$SpecialOffersMaxDiscountPercentage,$PrivateOffersMaxDiscountPercentage,$ServicePackWork,$ServiceDescription,$ServiceTablesAndColumns,$TablesDefaultValues,$Version,$SecurityCode,$BrowserClientId1,$BrowserClientId2,$EncodeAndEncryptPass){
					...
					if($LgSecurityCode === $SecurityCode){
						UpdateService::UpdateServiceProccess($ServiceCode,$ServiceStatus,$ServiceName,$ServiceStartTime,$ServiceExpTime,$ServiceFor,$ServiceMember,$MaxSellLimit,$AllOffersPermission,$SpecialOffersPermission,$PrivateOffersPermission,$AllMaxDiscountAmount,$SpecialOffersMaxDiscountAmount,$PrivateOffersMaxDiscountAmount,$AllMaxDiscountPercentage,$SpecialOffersMaxDiscountPercentage,$PrivateOffersMaxDiscountPercentage,$ServicePackWork,$ServiceDescription,$ServiceTablesAndColumns,$TablesDefaultValues,$Version,$SecurityCode,$BrowserClientId1,$BrowserClientId2,$EncodeAndEncryptPass,$PdoMainUserAccountDb,$PdoOrganizationUserAccount,$PdoServiceManage,$DbConnectionWithoutDbName,$LgUserUrl,$LgPosition,$ResponseLogin,$LgPositionRank);
					}else{
						return_response('Invalid Security code'); exit();
					}
				}

				private static function UpdateServiceProccess($ServiceCode,$ServiceStatus,$ServiceName,$ServiceStartTime,$ServiceExpTime,$ServiceFor,$ServiceMember,$MaxSellLimit,$AllOffersPermission,$SpecialOffersPermission,$PrivateOffersPermission,$AllMaxDiscountAmount,$SpecialOffersMaxDiscountAmount,$PrivateOffersMaxDiscountAmount,$AllMaxDiscountPercentage,$SpecialOffersMaxDiscountPercentage,$PrivateOffersMaxDiscountPercentage,$ServicePackWork,$ServiceDescription,$ServiceTablesAndColumns,$TablesDefaultValues,$Version,$SecurityCode,$BrowserClientId1,$BrowserClientId2,$EncodeAndEncryptPass,$PdoMainUserAccountDb,$PdoOrganizationUserAccount,$PdoServiceManage,$DbConnectionWithoutDbName,$LgUserUrl,$LgPosition,$ResponseLogin,$LgPositionRank){
					...
					$Response = FetchReuiredDataByGivenData("NameSearch::::$NameSearch",'Code',$PdoServiceManage,'service_list',$EncodeAndEncryptPass,'all',NULL,'all');
						
					if($Response['status'] === 'Success' && $Response['code'] === 200){
						if($Response['totalrows'] > 1){
							return_response('This sevice name already exist 3.1'); exit();
						}

						if($Response['msg'][0]->Code != $ServiceCode){
							return_response('This sevice name already exist 3.2'); exit();
						}
					...
					$Response = CheckGivenDataAvailability("Code::::$ServiceCode",$PdoServiceManage,'service_list',$EncodeAndEncryptPass);
					...
					$GivenData = "Status::::$ServiceStatus::,::ServiceMember::::$ServiceMember::,::Name::::$ServiceName::,::NameSearch::::$NameSearch::,::ShortDescription::::$ServicePackWork::,::Description::::$ServiceDescription::,::Code::::$ServiceCode::,::ServiceFor::::$ServiceFor::,::StartTime::::$ServiceStartTime::,::ExpTime::::$ServiceExpTime::,::LastUpdateBy::::$LgUserUrl::,::LastUpdateTime::::$CurrentTime::,::LastUpdatePosition::::$LgPosition::,::LastUpdateRank::::$LgPositionRank::,::AllOffersPermission::::$AllOffersPermission::,::SpecialOffersPermission::::$SpecialOffersPermission::,::PrivateOffersPermission::::$PrivateOffersPermission::,::AllMaxOfferDiscount::::$AllMaxOfferDiscount::,::SpecialMaxOfferDiscount::::$SpecialMaxOfferDiscount::,::PrivateMaxOfferDiscount::::$PrivateMaxOfferDiscount::,::TablesAndColumns::::$ServiceTablesAndColumns::,::TablesAndColumnsDefaultValues::::$TablesDefaultValues::,::MaxSellLimit::::$MaxSellLimit::,::Version::::$Version";

					$Response = UpdateGivenData($GivenData,"Code::::$ServiceCode",$PdoServiceManage,'service_list',$EncodeAndEncryptPass,'all');

					if($Response['status'] === 'Success' && $Response['code'] === 200){
						return_response('Service updated successfully',true,'Success',200);
					}else{
						return_response('Service update failed');
					}
				}
			}
			UpdateService::ValidedData($ServiceCode,$ServiceStatus,$ServiceName,$ServiceStartTime,$ServiceExpTime,$ServiceFor,$ServiceMember,$MaxSellLimit,$AllOffersPermission,$SpecialOffersPermission,$PrivateOffersPermission,$AllMaxDiscountAmount,$SpecialOffersMaxDiscountAmount,$PrivateOffersMaxDiscountAmount,$AllMaxDiscountPercentage,$SpecialOffersMaxDiscountPercentage,$PrivateOffersMaxDiscountPercentage,$ServicePackWork,$ServiceDescription,$ServiceTablesAndColumns,$TablesDefaultValues,$Version,$SecurityCode,$BrowserClientId1,$BrowserClientId2);
		}else{
