...
<?php
	...
	define("PageTitle", "Manage Services");
	define("CssFile", "ManageServices");
	require_once RootPath."Site_Header/index.php";
?>
<body class="No_Select_Strat">
	<H1 class='PageTitle'>MANAGE SERVICES</H1>
	<div class='Container'>
		<div class='button AddService'>
			<p>Add Service</p>
		</div>
		<div class='button CreatePlan'>
			<p>Create Plan</p>
		</div>
		<div class='button SearchService'>
			<p>Search Service</p>
		</div>
		<div class='button SearchPlan'>
			<p>Search Plan</p>
		</div>
	</div>
</body>
...
<script>
	$(document).ready(function(){
		$('.AddService').click(()=>{
			window.location.href = 'AddService/index.php';
		});

		$('.CreatePlan').click(()=>{
			window.location.href = 'CreatePlan/index.php';
		});
		$('.SearchService').click(()=>{
			window.location.href = 'SearchService/index.php';
		});

		$('.SearchPlan').click(()=>{
			window.location.href = 'SearchPlan/index.php';
		});
	});
</script>
</html>
