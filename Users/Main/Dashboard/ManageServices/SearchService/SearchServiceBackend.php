<?php
	...
	*/
	...
	if(isset($_POST['target']) && isset($_POST['SearchDataKey']) && isset($_POST['Token_CSRF']) && isset($_POST['BrowserClientId1']) && isset($_POST['BrowserClientId2'])){
				...
				if($_POST['SearchDataKey'] !== "undefined"){
					...
					class SearchServices{
						...
						private function SearchServicesRequest($SearchDataKey,$EncodeAndEncryptPass,$PdoServiceManage,$ResponseLogin){
							...
							$RequireUserDetails = 'Status::::Name::::Code::::StartTime::::StartTimeType::::ExpTime::::ExpTimeType::::LastUpdateTime::::TotalSelledPack';

							$Response = FetchReuiredDataByGivenData($SearchData,$RequireUserDetails,$PdoServiceManage,'service_list',$EncodeAndEncryptPass,'LikeLast',NULL,'all');
							...
							if($Response['status'] === 'Success' && $Response['code'] === 200){
								...
								foreach (get_defined_vars() as $SetVarKey=>$SetVarVal){ unset($$SetVarKey); } unset($SetVarKey,$SetVarVal);
								return_response('No Service Found',true,'Error',404);
							}
						}
					}
