...
<?php
	...
	define("PageTitle", "Manage Members");
	define("CssFile", "ManageMembers");
	require_once RootPath."Site_Header/index.php";
?>
<body class="No_Select_Strat">
	<H1 class='PageTitle'>MANAGE MEMBERS</H1>
	<div class='Container'>
		<div class='button AddNewMember'>
			<p>Add Member</p>
		</div>
...
<script>
	$(document).ready(function(){
		$('.AddNewMember').click(()=>{
			window.location.href = 'AddNewMember/index.php';
		});
