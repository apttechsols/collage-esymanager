		...
		<div class="SubContainer">
			...
			<div class="Form1">
				...
				<div class="PrimaryBatchIdBox">
					<p class='DtlTxt'><?php echo $GetUpdateUserData['msg']->PrimaryBatchId; ?></p>
					<p class='DtlTl'>Primary Batch Id</p>
				</div>

				<div class="SecondaryBatchIdBox">
					<p class='DtlTxt'><?php echo $GetUpdateUserData['msg']->SecondaryBatchId; ?></p>
					<p class='DtlTl'>Secondary Batch Id</p>
				</div>
				...
				<div class="FathersNameBox">
					<p class='DtlTxt'>Mr. <?php echo $GetUpdateUserData['msg']->FatherFullname; ?></p>
					<p class='DtlTl'>Father</p>
				</div>
				<div class="FathersMobileNumberBox">
					<p class='DtlTxt'><?php echo $GetUpdateUserData['msg']->FatherMobile; ?></p>
					<p class='DtlTl'>Father Mobile</p>
				</div>	
				<div class="FathersEmailBox">
					<?php if($GetUpdateUserData['msg']->FatherEmail != ''){ ?>
						<p class='DtlTxt'><?php echo $GetUpdateUserData['msg']->FatherEmail; ?></p>
					<?php }else{ ?>
						<p class='DtlTxt'><?php echo 'Unknown'; ?></p>
					<?php } ?>
					<p class='DtlTl'>Father Email</p>
				</div>
				<div class="BranchBox">
					<p class='DtlTxt'><?php echo $GetUpdateUserData['msg']->Branch; ?></p>
					<p class='DtlTl'>Branch</p>
				</div>
				<div class="YearBox">
					<p class='DtlTxt'><?php echo $GetUpdateUserData['msg']->StudyYear; ?></p>
					<p class='DtlTl'>Study Year</p>
				</div>
				
				<div class="SemesterBox">
					<p class='DtlTxt'><?php echo $GetUpdateUserData['msg']->Semester; ?></p>
					<p class='DtlTl'>Semester</p>
				</div>
